...
vi.mock('../src/config.js', () => ({
  config: {
    ...
    applicationId: 'canton-rebalancer',
  ...
  TEMPLATES: {
    ...
    PortfolioProposal: '#canton-rebalancer:Portfolio:PortfolioProposal',
    RebalanceRequest: '#canton-rebalancer:Portfolio:RebalanceRequest',
    RebalanceLog: '#canton-rebalancer:Portfolio:RebalanceLog',
    ...
    Referral: '#canton-rebalancer:RewardTracker:Referral',
    ReferralCredit: '#canton-rebalancer:RewardTracker:ReferralCredit',
